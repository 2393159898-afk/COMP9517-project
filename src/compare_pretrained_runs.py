...
def main() -> None:
    ...
    parser.add_argument(
        "summaries",
        nargs="+",
        help="Example: results/logs/pretrained_freeze_summary.json results/logs/pretrained_finetune_summary.json",
    )
    parser.add_argument(
        "--out-csv",
        default="results/logs/pretrained_ablation_summary.csv",
    )
        ...
        rows.append(
            {
                ...
                "freeze_backbone": summary["freeze_backbone"],
